...
def main():
	...
	declFile = open("../include/rocket/opengl/generated/gldecl.h", "w")
	defnFile = open("../include/rocket/opengl/generated/gldefn.h", "w")
	setupFile = open("../include/rocket/opengl/generated/glsetup.h", "w")
