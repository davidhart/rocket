...
def main():
	...
	declFile = open("../include/rocket/opengl/generated/gldecl.inl", "w")
	defnFile = open("../include/rocket/opengl/generated/gldefn.inl", "w")
	setupFile = open("../include/rocket/opengl/generated/glsetup.inl", "w")
